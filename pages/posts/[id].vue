<template>
    <article class="px-4 py-24 mx-auto max-w-7xl" itemid="#" itemscope itemtype="http://schema.org/BlogPosting">
      <div class="w-full mx-auto mb-12 text-left md:w-3/4 lg:w-1/2">
        <img src="https://i.redd.it/8q90jhmdfkua1.png" class="object-cover w-full h-64 bg-center rounded-lg" alt="Kutty" />
        ...
        <a class="flex items-center text-gray-700" href="#">
          <div class="avatar"><img src="https://i.redd.it/8q90jhmdfkua1.png" alt="Photo of Praveen Juge" /></div>
          <div class="ml-2">
